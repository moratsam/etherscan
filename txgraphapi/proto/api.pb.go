...
func (Tx_TxStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1dd11585dd0bdc80, []int{2, 0}
}
...
func (m *BlockBatch) GetBlocks() []*Block {
	if m != nil {
		return m.Blocks
	}
	return nil
...
func (*Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd11585dd0bdc80, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*BlockBatch)(nil), "proto.BlockBatch")
...
var fileDescriptor_1dd11585dd0bdc80 = []byte{
	...
	,
}
...
type TxGraphClient interface {
	...
	// Upserts a block.
	UpsertBlocks(ctx context.Context, in *BlockBatch, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *txGraphClient) UpsertBlocks(ctx context.Context, in *BlockBatch, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.TxGraph/UpsertBlocks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TxGraphServer interface {
	...
	// Upserts a block.
	UpsertBlocks(context.Context, *BlockBatch) (*emptypb.Empty, error)
	// Inserts the transactions.
...
func (*UnimplementedTxGraphServer) UpsertBlocks(ctx context.Context, req *BlockBatch) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpsertBlocks not implemented")
}
...
func _TxGraph_UpsertBlocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockBatch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TxGraphServer).UpsertBlocks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TxGraph/UpsertBlocks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TxGraphServer).UpsertBlocks(ctx, req.(*BlockBatch))
	}
...
var _TxGraph_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UpsertBlocks",
			Handler:    _TxGraph_UpsertBlocks_Handler,
		},
		{
