...
// Source: github.com/moratsam/etherscan/dbspgraph (interfaces: Serializer)
...
func (m *MockSerializer) Serialize(arg0 interface{}) (*types.Any, error) {
	m.ctrl.T.Helper()
...
func (m *MockSerializer) Unserialize(arg0 *types.Any) (interface{}, error) {
	m.ctrl.T.Helper()
