...
func (f *workerExecutorFactory) postStepCallback(ctx context.Context, g *bspgraph.Graph, activeInStep int) error {
	// Serialise the local aggregated values.
	...
	// Receive back the step message with global aggregated values.
...
func mergeWorkerAggregatorDeltas(g *bspgraph.Graph, deltaValues map[string]*types.Any, serializer Serializer) error {
...
func serializeAggregatorValues(g *bspgraph.Graph, serializer Serializer, serializeDeltas bool) (map[string]*types.Any, error) {
	...
	var (
		aggrValues = make(map[string]*types.Any)
		aggrVal    interface{}
	)
...
func setAggregatorValues(g *bspgraph.Graph, aggrValues map[string]*types.Any, serializer Serializer) error {
