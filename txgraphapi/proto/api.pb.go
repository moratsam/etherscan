...
func (m *Walletss) Reset()         { *m = Walletss{} }
func (m *Walletss) String() string { return proto.CompactTextString(m) }
func (*Walletss) ProtoMessage()    {}
func (*Walletss) Descriptor() ([]byte, []int) {
	return fileDescriptor_1dd11585dd0bdc80, []int{4}
}
func (m *Walletss) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Walletss) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Walletss.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Walletss) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Walletss.Merge(m, src)
}
func (m *Walletss) XXX_Size() int {
	return m.Size()
}
func (m *Walletss) XXX_DiscardUnknown() {
	xxx_messageInfo_Walletss.DiscardUnknown(m)
}

var xxx_messageInfo_Walletss proto.InternalMessageInfo

func (m *Walletss) GetWallets() []*Wallet {
	if m != nil {
		return m.Wallets
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Txs)(nil), "proto.Txs")
	proto.RegisterType((*Wallet)(nil), "proto.Wallet")
	proto.RegisterType((*Walletss)(nil), "proto.Walletss")
...
var fileDescriptor_1dd11585dd0bdc80 = []byte{
	...
	,
}
...
type TxGraphClient interface {
	...
	InsertTxs(ctx context.Context, in *Txs, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// Upserts a wallet.
	UpsertWallets(ctx context.Context, in *Walletss, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *txGraphClient) InsertTxs(ctx context.Context, in *Txs, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *txGraphClient) UpsertWallets(ctx context.Context, in *Walletss, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type TxGraphServer interface {
	...
	// Inserts the transactions.
	InsertTxs(context.Context, *Txs) (*emptypb.Empty, error)
	// Upserts a wallet.
	UpsertWallets(context.Context, *Walletss) (*emptypb.Empty, error)
	// Streams all transactions connected to a wallet.
...
func (*UnimplementedTxGraphServer) InsertTxs(ctx context.Context, req *Txs) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InsertTxs not implemented")
}
func (*UnimplementedTxGraphServer) UpsertWallets(ctx context.Context, req *Walletss) (*emptypb.Empty, error) {
...
func _TxGraph_InsertTxs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TxGraphServer).InsertTxs(ctx, req.(*Txs))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TxGraph_UpsertWallets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TxGraphServer).UpsertWallets(ctx, req.(*Walletss))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *Walletss) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Walletss) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Walletss) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Walletss) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Walletss: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Walletss: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
